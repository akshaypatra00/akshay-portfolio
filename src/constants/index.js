 ...
 const projects = [
  {
    ...
    des: "A production-grade decentralized app distribution platform that enables developers to deploy apps directly from GitHub into a community-driven store.",
    ...
    type: "development",
    problem:
      "Traditional app stores impose centralized control, long approval cycles, and limited visibility for indie developers.",
    solution:
      "Built a decentralized, GitHub-powered app distribution platform with instant deployments and real-time analytics.",
    features: [
      "GitHub OAuth integration",
      "Automated APK detection",
    ...
    metrics:
      "End-to-end GitHub-to-store deployment pipeline with strict RLS enforcement",
  ...
  liveDemo: "https://www.appflux.in/store/7b8936f5-9607-493b-acb6-de7ec668988b"
  },
   ...
   
  {
    ...
    liveDemo: "https://www.appflux.in/store/4954a7d3-0cd0-4a4c-903e-cd091abf9751"
  },
  {
    id: 2,
